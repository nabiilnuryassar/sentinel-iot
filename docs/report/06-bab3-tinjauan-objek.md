...
Penelitian dan pengembangan sistem Sentinel-IoT dilaksanakan dengan mengambil studi kasus pada sebuah *software house* bernama **Kanezza Tech**. Sebagai perusahaan yang bergerak di bidang pengembangan perangkat lunak dan solusi teknologi, Kanezza Tech mengelola dan mengembangkan berbagai ekosistem perangkat Internet of Things (IoT) yang membutuhkan pemantauan keamanan yang ketat. Objek penelitian ini berfokus pada implementasi sistem perangkat lunak (*software system*) berbasis web yang berjalan pada infrastruktur *server* perusahaan untuk memantau aset-aset IoT mereka.

Sistem ini dikembangkan sebagai solusi atas kebutuhan operasional Kanezza Tech dalam memantau keamanan ekosistem perangkat IoT yang semakin kompleks. Dalam konteks lingkungan perusahaan ini, perangkat IoT mencakup berbagai jenis sensor, aktuator, *gateway*, dan perangkat *embedded* yang terhubung ke jaringan internet dan rentan terhadap serangan siber. Sentinel-IoT dirancang untuk menyediakan antarmuka terpusat (*centralized dashboard*) yang memungkinkan pengelola sistem dan tim IT di Kanezza Tech untuk memantau status keamanan seluruh perangkat IoT secara *real-time*, mendeteksi anomali, mengelola insiden keamanan, serta melakukan tindakan mitigasi seperti *quarantine* terhadap perangkat yang terindikasi terkompromi.
